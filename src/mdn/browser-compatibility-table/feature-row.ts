 ...
 */
export function getSupportClassName(support: SupportStatementExtended | undefined, browser: BrowserStatement): SupportClassName {
  if (!support) {
    return 'unknown';
  }
 ...
 */
export function labelFromString(version: string | boolean | null | undefined, browser: BrowserStatement): string {
 ...
 * @param {BrowserStatement} browser - The browser statement.
 * @returns {string} A lit-html template result representing the version label.
 */
export function versionLabelFromSupport(added: string | boolean | null | undefined, removed: string | boolean | null | undefined, browser: BrowserStatement): string {
